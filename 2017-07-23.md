...
Basically, for me the json can be modified to work with json2csv, but it does not produce a real .csv.     I can produce a json file that looks correctly formatted, but json2csv has errors when parsing it.
