...
#### HTML glyphs
I realized that using some symbols in Annotations was causing difficulty for Hypothesis, so I need to use html glyphs, for example representing the less-than sign &lt; typed in as &amp;lt;.
